...
apt-get install -y php7.4-curl php7.4-cli php7.4-intl php7.4-mysqlnd php7.4-gd php7.4-fpm php7.4-mbstring php7.4-xml unzip nginx mysql-server-8.0 php7.4-xdebug
...
mysql -uroot <<< "CREATE DATABASE restapi"
mysql -uroot <<< "CREATE DATABASE restapi_test"
echo "Done!"
